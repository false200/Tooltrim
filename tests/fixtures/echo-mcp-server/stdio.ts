  ...
  tools: [
    {
      name: "echo",
      description:
        "This tool echoes the provided text back to the caller. Please use this when you want to verify tool routing in Tooltrim. Returns a JSON object containing the echoed text.",
      inputSchema: {
        type: "object",
